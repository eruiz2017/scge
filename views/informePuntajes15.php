...
?>
  ...
  <html>
      ...
      <?php
          $dataPoints = array(
              array("y" => $datos[70]['ponderacion_respuesta'], "label" => $datos[70]['descripcionrespuesta']),
              array("y" => $datos[71]['ponderacion_respuesta'], "label" => $datos[71]['descripcionrespuesta']),
              array("y" => $datos[72]['ponderacion_respuesta'], "label" => $datos[72]['descripcionrespuesta']),
              array("y" => $datos[73]['ponderacion_respuesta'], "label" => $datos[73]['descripcionrespuesta']),
              array("y" => $datos[74]['ponderacion_respuesta'], "label" => $datos[74]['descripcionrespuesta']),
          );
      ?>
