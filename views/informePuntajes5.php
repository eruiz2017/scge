...
$sumartoria5= $datos[22]['ponderacion_respuesta']+$datos[23]['ponderacion_respuesta']+
 ...
 $total5=$sumartoria5/48;
  ...
  <html>
      ...
      <?php
          $dataPoints = array(
              array("y" => $datos[22]['ponderacion_respuesta'], "label" => $datos[22]['descripcionrespuesta']),
              array("y" => $datos[23]['ponderacion_respuesta'], "label" => $datos[23]['descripcionrespuesta']),
              array("y" => $datos[24]['ponderacion_respuesta'], "label" => $datos[24]['descripcionrespuesta']),
              array("y" => $datos[25]['ponderacion_respuesta'], "label" => $datos[25]['descripcionrespuesta']),
          );
      ?>
          ...
          <script type="text/javascript">
              ...
              $(function () {
                  var chart = new CanvasJS.Chart("chartContainer", {
                      ...
                      title: {
                          text: "<?php echo $datos4[4]['NOMBREITEM'] ?> <?php echo round($total5*100),'%' ?>"
                      },
                      axisY: {
                          title: "Puntos",
